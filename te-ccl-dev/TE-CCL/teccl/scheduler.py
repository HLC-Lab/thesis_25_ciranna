...
from teccl.topologies.dragonfly import Dragonfly
from teccl.topologies.dragonflyPlus import DragonflyPlus
from teccl.topologies.dragonflyPlusRing import DragonflyPlusRing
...
class TECCLSolver(object):
    ...
    def get_topology(self, topology_params: TopologyParams) -> Topology:
        ...
        elif topology_params.name == "Dragonfly":  # <-- aggiungilo qui
            return Dragonfly(topology_params)
        elif topology_params.name == "DragonflyPlus":  # <-- aggiungilo qui
            return DragonflyPlus(topology_params)
        elif topology_params.name == "DragonflyPlusRing":  # <-- aggiungilo qui
            return DragonflyPlusRing(topology_params)
        elif topology_params.name == "Star":  # <-- aggiungilo qui
